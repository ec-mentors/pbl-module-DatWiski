...
public class CategoryController {
    ...
    @GetMapping
    public ResponseEntity<List<CategoryResponse>> getAllCategories(AppUser appUser) {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<CategoryResponse> getCategoryById(@PathVariable Long id, AppUser appUser) {
    ...
    @PostMapping
    public ResponseEntity<CategoryResponse> createCategory(@Valid @RequestBody CategoryRequest request, AppUser appUser) {
        try {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<CategoryResponse> updateCategory(@PathVariable Long id, @Valid @RequestBody CategoryRequest request, AppUser appUser) {
    ...
    @DeleteMapping("/{id}")
    public ResponseEntity<Void> deleteCategory(@PathVariable Long id, @RequestParam(required = false) Long newCategoryId, AppUser appUser) {
        try {
    ...
    public ResponseEntity<CategoryResponse> mergeCategories(@PathVariable Long sourceId, @PathVariable Long targetId, AppUser appUser) {
        try {
    ...
    public ResponseEntity<Map<String, Object>> getPieChartData(AppUser appUser) {
    ...
    public ResponseEntity<Map<String, Object>> getSpendData(AppUser appUser) {
